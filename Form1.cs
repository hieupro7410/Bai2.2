...
namespace Bai2._2
{
    public partial class Form1 : Form
    {
        ...
        Process MyProc;
        ThreadPriority[] tPrio = { ThreadPriority.Lowest, ThreadPriority.BelowNormal, ThreadPriority.Normal, ThreadPriority.AboveNormal, ThreadPriority.Highest };
        void TinhTich(object obj)
        {
            ...
            for (h = p.sr; h < p.er; h++)
                ...
                {
                    double s = 0;
                    for (k = 0; k < N; k++) s = s + A[h, k] * B[k, c]; C[h, c] = s;
                }
            stateLst[p.id] = 1;
